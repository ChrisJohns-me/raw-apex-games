...
export class Rank {
    ...
    public get friendlyName(): string {
        return `${this.tierName} ${this.tierDivision}`;
    }
    ...
    public get tierName(): RankTierName {
        return this._givenTierName ?? (this._givenScore ? Rank.getTierNameFromScore(this._givenScore) : RankTierName.Bronze);
    }

    public get tierDivision(): RankTierDivision {
        return (
            this._givenTierDivision ??
            (this._givenScore ? Rank.getTierDivisionFromScore(this._givenScore) : Rank.getDefaultTierDivision(this.tierName))
        );
    }
    ...
    constructor({ score, tierName, tierDivision }: RankConstructor = {}) {
        if (typeof score === "number") this._givenScore = score;
