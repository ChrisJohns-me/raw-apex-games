import { RankTierHEXColor, RankTierName } from "@raw-apex-games-app/app/common/rank/rank";
...
export const ChartRankPlatinumHEXColor = RankTierHEXColor[RankTierName.Platinum];
export const ChartRankDiamondHEXColor = RankTierHEXColor[RankTierName.Diamond];
export const ChartRankMasterHEXColor = RankTierHEXColor[RankTierName.Master];
export const ChartRankApexpredatorHEXColor = RankTierHEXColor[RankTierName.ApexPredator];
