...
export const LegendList: Legend[] = [
    ...
    new Legend("#character_maggie_NAME"),
    new Legend("#character_mirage_NAME"),
    new Legend("#character_newcastle_NAME"),
...
export function getLegendBGColor(legendId?: string): string {
    ...
    const legendColors = [
        ...
        { legendId: "#character_maggie_NAME", rgbColor: "#e8e65a" },
        { legendId: "#character_mirage_NAME", rgbColor: "#ba8940" },
        { legendId: "#character_newcastle_NAME", rgbColor: "#5252e1" },
