...
import { ReportedPlayerPageView } from "../pages/reported-players/reported-players-page.component";
...
export class MainWindowComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    public reportedPlayersPageView: ReportedPlayerPageView = ReportedPlayerPageView.Latest;
    ...
    private captionGenerator(): string {
        ...
        const captions = [
            ...
            "The Siren will gift us today",
            "Siren bless me with sight",
            "I will shed bloð and honor the Siren",
            "Trust in the Siren",
            "Prove your strength before the gods",
            "The hunt begins",
            "The true test is before the Siren",
            "The Siren graces your victory",
        ];
